...
import { useState as useState3, useEffect, useCallback, useMemo as useMemo2 } from "react";
...
function CalendarGrid({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }, children: [
      ...
      /* @__PURE__ */ jsxs("span", { style: { fontWeight: 600, color: isDark ? "#fff" : "#000" }, children: [
        months[month],
        " ",
        year
      ] }),
    ...
    /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2, marginBottom: 4 }, children: days.map((d) => /* @__PURE__ */ jsx(
      "div",
      {
        style: {
          textAlign: "center",
...
function TimeSlots({
  ...
  const isDark = theme === "dark";
  return /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginTop: 16 }, children: slots.map((slot) => {
...
function BookingForm({
  ...
  return /* @__PURE__ */ jsxs2("form", { onSubmit: handleSubmit, style: { display: "flex", flexDirection: "column", gap: 12, marginTop: 16 }, children: [
    ...
    /* @__PURE__ */ jsxs2("div", { children: [
      ...
      /* @__PURE__ */ jsxs2(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsx3("option", { value: "", children: t.selectService }),
            services.map((s) => /* @__PURE__ */ jsx3("option", { value: s, children: s }, s))
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx3("label", { style: labelStyle, children: t.message }),
      /* @__PURE__ */ jsx3(
        "textarea",
        {
          value: message,
...
function Spinner({ color }) {
  return /* @__PURE__ */ jsx4("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", padding: "40px 0", gap: 12 }, children: /* @__PURE__ */ jsx4(
    "div",
    {
      style: {
        width: 28,
...
function BookingWidget({
  ...
  const [step, setStep] = useState3("calendar");
  const [loadingAvailability, setLoadingAvailability] = useState3(false);
  const [loadingBooking, setLoadingBooking] = useState3(false);
  const [availability, setAvailability] = useState3([]);
  const [errorMsg, setErrorMsg] = useState3("");
  const [month, setMonth] = useState3(() => (/* @__PURE__ */ new Date()).getMonth());
  const [year, setYear] = useState3(() => (/* @__PURE__ */ new Date()).getFullYear());
  const [selectedDate, setSelectedDate] = useState3(null);
  const [selectedTime, setSelectedTime] = useState3(null);
  const selectedSlots = useMemo2(() => {
    if (!selectedDate) return [];
    const day = availability.find((d) => d.date === selectedDate);
    return day?.slots || [];
  }, [selectedDate, availability]);
  const fetchAvailability = useCallback(async (m, y) => {
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs3(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs3("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }, children: [
                /* @__PURE__ */ jsx4("h2", { style: { margin: 0, fontSize: 18, fontWeight: 700, color: isDark ? "#fff" : "#000" }, children: t.title }),
                /* @__PURE__ */ jsx4(
                  "button",
                  {
                    onClick: handleClose,
              ...
              step === "calendar" && /* @__PURE__ */ jsx4(Fragment, { children: loadingAvailability ? /* @__PURE__ */ jsxs3("div", { style: { textAlign: "center" }, children: [
                /* @__PURE__ */ jsx4(Spinner, { color: accentColor }),
                /* @__PURE__ */ jsx4("p", { style: { color: isDark ? "#8888AA" : "#999", fontSize: 14, margin: 0 }, children: t.loading })
              ] }) : availability.length === 0 ? /* @__PURE__ */ jsx4("div", { style: { textAlign: "center", padding: "40px 0", color: isDark ? "#8888AA" : "#999" }, children: t.noSlots }) : /* @__PURE__ */ jsxs3(Fragment, { children: [
                /* @__PURE__ */ jsx4(
                  CalendarGrid,
                  {
                    availability,
                ...
                selectedDate && selectedSlots.length > 0 && /* @__PURE__ */ jsxs3("div", { style: { marginTop: 16 }, children: [
                  /* @__PURE__ */ jsx4("p", { style: { fontSize: 14, fontWeight: 500, color: isDark ? "#8888AA" : "#666", margin: "0 0 8px" }, children: t.selectTime }),
                  /* @__PURE__ */ jsx4(
                    TimeSlots,
                    {
                      slots: selectedSlots,
              ...
              step === "form" && /* @__PURE__ */ jsxs3(Fragment, { children: [
                /* @__PURE__ */ jsxs3(
                  "button",
                  {
                ...
                errorMsg && /* @__PURE__ */ jsx4("div", { style: { padding: "8px 12px", borderRadius: 8, background: "#ff444420", color: "#ff6666", fontSize: 13, marginBottom: 8 }, children: errorMsg }),
                /* @__PURE__ */ jsx4(
                  BookingForm,
                  {
              ...
              step === "success" && /* @__PURE__ */ jsxs3("div", { style: { textAlign: "center", padding: "24px 0" }, children: [
                /* @__PURE__ */ jsx4("div", { style: { fontSize: 48, marginBottom: 16 }, children: "\u2713" }),
                /* @__PURE__ */ jsx4("h3", { style: { color: accentColor, margin: "0 0 8px", fontSize: 18 }, children: t.successTitle }),
                /* @__PURE__ */ jsx4("p", { style: { color: isDark ? "#8888AA" : "#666", fontSize: 14, margin: "0 0 24px" }, children: t.successMsg }),
                /* @__PURE__ */ jsxs3("div", { style: { display: "flex", gap: 8, justifyContent: "center" }, children: [
                  /* @__PURE__ */ jsx4(
                    "button",
                    {
                      onClick: handleClose,
              ...
              step === "error" && /* @__PURE__ */ jsxs3("div", { style: { textAlign: "center", padding: "24px 0" }, children: [
                /* @__PURE__ */ jsx4("div", { style: { fontSize: 48, marginBottom: 16 }, children: "\u2715" }),
                /* @__PURE__ */ jsx4("h3", { style: { color: "#ff6666", margin: "0 0 8px", fontSize: 18 }, children: t.errorTitle }),
                /* @__PURE__ */ jsx4("p", { style: { color: isDark ? "#8888AA" : "#666", fontSize: 14, margin: "0 0 24px" }, children: errorMsg }),
                /* @__PURE__ */ jsx4(
                  "button",
                  {
                    onClick: handleReset,
              ...
              /* @__PURE__ */ jsx4("div", { style: { textAlign: "center", marginTop: 20, fontSize: 11, color: isDark ? "#333" : "#ccc" }, children: "powered by Techode" })
            ]
          }
        )
      }
